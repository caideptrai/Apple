...
def index():
    ...
    renderSideBar = render_template('components/SideBar.html', genres_query = genres_query)
...
def product_detail(product_id):
    ...
    return render_template('product-detail.html', Breadcrumbs = renderBreadcrumbs, game_query = game_query, genres_of_game = game_query.genres_of_game, publisher = game_query.publisher, game_id=product_id)
...
#     games_recommended = []
#     IP = Genre.query.filter_by(genre_name='Iphone').first()

#     for game in games_by_price:
#         if IP in game.platforms_of_game:
...
def featured_recommended():
    ...
    # Filter games by genre "iPhone"
    iphone_genre = Genre.query.filter_by(genre_name='iPhone').first()
    games_recommended = []
    if iphone_genre:
        games_recommended = iphone_genre.games_of_genre  # Access games through genre relationship
